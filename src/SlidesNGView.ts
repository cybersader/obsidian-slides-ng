...
export class SlidesNGView extends ItemView {
  ...
  private async refresh(): Promise<void> {
    ...
    try {
      ...
      const html = renderDeck(markdown, file.path, {
        ...
        autoFit: settings.autoFitSlides,
        renderObsidianCallouts: settings.renderObsidianCallouts,
  ...
  private renderDefaults() {
    ...
    return {
      ...
      autoFit: s.autoFitSlides,
      renderObsidianCallouts: s.renderObsidianCallouts,
